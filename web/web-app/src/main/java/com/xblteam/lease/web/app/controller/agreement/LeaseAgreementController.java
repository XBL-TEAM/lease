package com.xblteam.lease.web.app.controller.agreement;
...
public class LeaseAgreementController {
    ...
    public Result<List<AgreementItemVo>> listItem() {
        List<AgreementItemVo> list = leaseAgreementService.listItemByPhone(
                LoginUserHolder.getLoginUser().getUsername());
