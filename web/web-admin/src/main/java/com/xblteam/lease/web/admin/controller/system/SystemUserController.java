...
public class SystemUserController {
    ...
    public Result<IPage<SystemUserItemVo>> page(
        ...
        IPage<SystemUserItemVo> iPage = systemUserService.queryPage(current, size, queryVo);
    ...
    public Result saveOrUpdate(
        ...
        if (password != null) systemUser.setPassword(DigestUtils.md5Hex(password));
    ...
    public Result<Boolean> isUsernameExists(
        ...
        long count = systemUserService.count(new LambdaQueryWrapper<SystemUser>()
